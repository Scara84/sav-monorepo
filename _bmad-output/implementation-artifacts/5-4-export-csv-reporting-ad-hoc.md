...
- [ ] **Task 1 — Handler `export-csv-handler.ts`** (AC #1, #4, #5, #6)
- [ ] **Task 2 — Générateur CSV interne** (AC #2, #3)
  - [ ] 2.1 Helper `generateCsv(rows: ExportRow[], columns: ColumnDef[]): Buffer` avec BOM + escape quote
  - [ ] 2.2 Helper `generateXlsx(rows, columns): Buffer` via SheetJS
- [ ] **Task 3 — Routing + rewrites** (AC #7)
- [ ] **Task 4 — UI bouton + menu** (AC #8)
- [ ] **Task 5 — Composable `useSavExport.ts`** (AC #9)
- [ ] **Task 6 — Tests API** (AC #10)
- [ ] **Task 7 — Tests UI** (AC #11)
- [ ] **Task 8 — Docs** (AC #12)
- [ ] **Task 9 — Validation** (AC #13)
